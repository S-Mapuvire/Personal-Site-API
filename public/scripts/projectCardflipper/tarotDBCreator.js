// _id, Name, Image, Title, Description
...
let names = [
    ...
    let titles = ["The path taken through the great mysteries of life", 
    "As above, so below", 
    "Divine law", 
...
async function insertEntries(){
    ...
    for(let i = 0; i < 22; i++) {
        await db.insertOne(
            {"_id": i, "Name": names[i], "Image": images[i], "Title": titles[i], "Description": descriptions[i]}
        );
    }
}
